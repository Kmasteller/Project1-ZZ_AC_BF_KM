...
function getParkData(clickedPark){
    ...
    $.ajax({
      ...
      console.log(lat, long);
          ...
          $("#currentTemp").append(currentTemp+"℉"+" "+currentWeather);
...
// // when hover over the addFav button, show notification
// $("#addFav").on("mouseover", function(){
//   $("#popup").style.display = "block";
// });
// //when not over the addFav button, hide notification
// $("#addFav").on("mouseout", function(){
//   $("#popup").style.display = "none";
// });
//when user clicked on addFav button
var favParksArray = [];
